...
#include "Commands/Shooting/MoveRamp.h"
...
OI::OI() {
	...
	//bButton->WhileHeld(new Climb());
	bButton->ToggleWhenPressed(new Slappy());
	aButton->ToggleWhenPressed(new RunIntake());
	yButton->WhenPressed(new FlipChassis());
	backButton->WhenPressed(new MoveRamp(false));
	startButton->WhenPressed(new MoveRamp(true));
	xButton->WhenPressed(new ShootRamp());
